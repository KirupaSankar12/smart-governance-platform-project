...
public class GeminiService {
    ...
    public AiGovernanceResponse analyzeGovernance() {
        if (!isConfigured()) {
            return AiGovernanceResponse.unavailable("Gemini API key not configured on the server.");
        }
        try {
            ...
            return AiGovernanceResponse.unavailable("AI analysis temporarily unavailable.");
        }
    }

    /**
     * Answers a specific admin question using live CivicPulse data as context.
     * The AI is strictly instructed to use only the supplied data.
     */
    public AiGovernanceResponse chat(String question) {
        ...
        try {
            ...
            return AiGovernanceResponse.unavailable("AI chat temporarily unavailable.");
        }
    }
